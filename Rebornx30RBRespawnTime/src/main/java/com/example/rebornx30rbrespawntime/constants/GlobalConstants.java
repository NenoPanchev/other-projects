...
public class GlobalConstants {
    public static final String EXCLUDED_RAIDBOSSES = "Valakas Antharas Baium Queen Ant Sailren Benom Scarlet van Halisha Eilhalder von Hellmann" +
            " Soul of Water Ashutar Soul of Fire Nastron Icicle Emperor Bumbalump Daimon the White-Eyed Lilith Anakim";
    ...
    public static final int LEVEL_BRACKET = 54;
}
